...
mod tests {
    ...
    use crate::{
        ArchiveEntry, ArchiveEntryKind, ArchiveFormat, CopyPathMode, Error, NetworkPolicy,
        OutputSymlinkMode, PreparePathMode, RemoteExecution, ResourceRequest, SandboxMode,
        WorkspacePath,
    };
